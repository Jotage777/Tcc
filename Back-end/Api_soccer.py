...
class Greenzord_jogos(Resource):
    def post(jogos: jogos_modelo):
        Banco_de_dados.add_jogos(jogos.campeonato, jogos.id, jogos.time_casa, jogos.resultado_casa, jogos.time_fora,
                                 jogos.resultado_fora, jogos.date, jogos.odd_casa, jogos.odd_fora, jogos.odd_empate)
...
class Greenzord_apostas(Resource):
    def post(aposta: apostas_modelo):
        Banco_de_dados.add_apostas(aposta.mercado, aposta.valor_apostado, aposta.odd_aposta, aposta.id_bot,
                                   aposta.id_jogo)
