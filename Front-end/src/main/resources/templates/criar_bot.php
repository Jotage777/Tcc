    ...
    <form action="criar_bot.php" method="POST">
        <fieldset>
            ...
            <div class="inputBox">
                ...
                <input type="number" step="0.01" name="oddmin" id="oddmin" class="inputBotIntervalo" value="0.01"
                       min="0.01" max="999.99" required>
                <label for="oddmax">á:</label>
                <input type="number" step="0.01" name="oddmax" id="oddmax" class="inputBotIntervalo" value="999.99"
                       min="0.01" max="999.99" required>
            </div>
            <br>
            ...
            <div class="inputBox">
                ...
                <input type="number" name="finamin" id="finamin" class="inputBotIntervalo" value="0" min="0" max="99"
                       required>
            ...
            <div class="inputBox">
                ...
                <input type="number" name="possemin" id="possemin" class="inputBotIntervalo" value="0" min="0" max="100"
                       required>
                <label for="possemax">á:</label>
                <input type="number" name="possemax" id="possemax" class="inputBotIntervalo" value="100" min="0"
                       max="100" required>
            </div>
            <br>
