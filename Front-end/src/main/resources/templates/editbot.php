...
<div class="content" id="content">
    ...
    <fieldset>
        ...
        <div class="inputBox">
            <input type="number" name="responsa" id="responsa" class="inputBot" value="<?php echo $responsabilidade ?>"
                   required>
        ...
        <div class="inputBox">
            ...
            <input type="number" step="0.01" name="oddmin" id="oddmin" class="inputBotIntervalo"
                   value="<?php echo $odd_minima ?>" min="0.01" max="999.99" required>
            <label for="oddmax">á:</label>
            <input type="number" step="0.01" name="oddmax" id="oddmax" class="inputBotIntervalo"
                   value="<?php echo $odd_maxima ?>" min="0.01" max="999.99" required>
        </div>
        <br>
        <!-- Times a serem apostados -->
        <p>Times (Para Apostar):</p>
        <input type="radio" id="favapo" name="timapo" value="favapo" <?php echo $apostar == 'favapo' ? 'checked' : '' ?>
               required>
        <label for="casa">Favorito</label>
        <br>
        <input type="radio" id="zebraapo" name="timapo"
               value="zebraapo" <?php echo $apostar == 'zebraapo' ? 'checked' : '' ?> required>
        <label for="fora">Zebra</label>
        <br>
        <input type="radio" id="casaapo" name="timapo"
               value="casaapo" <?php echo $apostar == 'casaapo' ? 'checked' : '' ?> required>
        <label for="ambos">Casa</label>
        <br>
        <input type="radio" id="foraapo" name="timapo"
               value="foraapo" <?php echo $apostar == 'foraapo' ? 'checked' : '' ?> required>
        <label for="ambos">Fora</label>
        <br>
        <!-- Times a serem analisados -->
        <p>Times (Para Estatísticas):</p>
        <input type="radio" id="favesta" name="timesta"
               value="favesta" <?php echo $analisar == 'favesta' ? 'checked' : '' ?> required>
        <label for="casa">Favorito</label>
        <br>
        <input type="radio" id="zebraesta" name="timesta"
               value="zebraesta" <?php echo $analisar == 'zebraesta' ? 'checked' : '' ?> required>
        <label for="fora">Zebra</label>
        <br>
        <input type="radio" id="casaesta" name="timesta"
               value="casaesta" <?php echo $analisar == 'casaesta' ? 'checked' : '' ?> required>
        <label for="casa">Casa</label>
        <br>
        <input type="radio" id="foraesta" name="timesta"
               value="foraesta" <?php echo $analisar == 'foraesta' ? 'checked' : '' ?> required>
        ...
        <div class="inputBox">
            ...
            <input type="number" name="tempomin" id="tempomin" class="inputBotIntervalo"
                   value="<?php echo $tempo_jogo_minimo ?>" min="0" max="99" required>
            <label for="tempomin">á:</label>
            <input type="number" name="tempomax" id="tempomax" class="inputBotIntervalo"
                   value="<?php echo $tempo_jogo_maximo ?>" min="0" max="99" required>
        </div>
        <!-- Finalizações do time ou ambos no jogo todo -->
        <p>Finalizações:</p>
        <div class="inputBox">
            <label for="finamin">de:</label>
            <input type="number" name="finamin" id="finamin" class="inputBotIntervalo"
                   value="<?php echo $finalizacao_min ?>" min="0" max="99" required>
            <label for="finamax">á:</label>
            <input type="number" name="finamax" id="finamax" class="inputBotIntervalo"
                   value="<?php echo $finalizacao_max ?>" min="0" max="99" required>
        </div>
        <!-- Adicionar posse de bola minima e maxima -->
        <p>Posse de Bola:</p>
        <div class="inputBox">
            <label for="possemin">de:</label>
            <input type="number" name="possemin" id="possemin" class="inputBotIntervalo"
                   value="<?php echo $posse_bola_min ?>" min="0" max="100" required>
            <label for="possemax">á:</label>
            <input type="number" name="possemax" id="possemax" class="inputBotIntervalo"
                   value="<?php echo $posse_bola_max ?>" min="0" max="100" required>
        </div>
        <br>
